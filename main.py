...
if TRAIN_NNET:
    ...
    with open(featdir + '/maxlength', 'r') as fid:
        ...
        featreader_dev = feature_reader.FeatureReader(featdir_dev + '/feats.scp', featdir_dev +'/cmvn.scp', featdir_dev + '/utt2spk', int(config.get('nnet', 'context_width')), max_input_length_dev)
